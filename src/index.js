...
function renderContact(contact) {
  ...
  const { id, name, email, phone, website, address: { street, suite, city, zipcode }, company: { name: CoName } } =  contact;
...
function render(filteredContacts) {
  ...
  const content = filteredContacts.map(renderContact).join("");
